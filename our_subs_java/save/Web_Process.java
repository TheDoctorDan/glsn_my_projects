...
public class Web_Process {
    ...
    throws WPException{
        ...
        try {
            this.program = Program.get_Program(servlet_Path_Name);
        }
        catch(Database_Front_Exception dbfe){
    ...
    throws ServletException, IOException {
        my_Servlet.getServletContext().getRequestDispatcher("/portal_Pages/"+ this.subscriber_Organization_Portal.getDestination_Url().getValue()).forward(my_Request, my_Response);
    }
    ...
    public synchronized void error_End(String message, Exception ex) {
        ...
        if(this.subscriber_Organization_Portal.getKiosk_Mode().getValue().booleanValue()){
            ...
            out.println("<html>");
            out.println("   <title>ERROR END</title>");
            out.println("   <body>");
            ...
            out.println("       <form name='error_end' method='post' action='" + this.getSubscriber_Organization_Portal().getWeb_Root()+
            "/Launcher_Servlet'>");
    ...
    public synchronized void error_End(Exception ex) {
        ...
        if(this.subscriber_Organization_Portal.getKiosk_Mode().getValue().booleanValue()){
            ...
            log("Fatal Error in "+ servlet_Path_Name, ex);
            ...
            out.println("       <p>Detail of Error:<br>");
            //        out.println("       <p>Status:"+(String)status_Stack.getLast()+":");
            out.println("       <p>Status:"+wpStatus_Stack.getStatus_Node().getStatus_Text()+":");
            if(ex != null){
                out.println("       <p>Stack Trace:<br>");
                out.println("       <p>");
                StackTraceElement[] stackTraceElement = ex.getStackTrace();
...
//            out.println("location.replace(\""+this.getSubscriber_Organization_Portal().getWeb_Root()+
//            "/Launcher_Servlet"+"&action=Reload"+
//            "&process_Id=" + this.id +
//            "&ps_Step=" + this.action_Count+
//            "\");");
            ...
            out.println("   <body>");
            out.println("       <p>Error in " + servlet_Path_Name + ".<br>");
            out.println("       <p>"+StringPlus.html_Encode(message)+"<br>");
            out.println("       <p>Detail of Error:<br>");
            if(ex != null){
                out.println("       <p>"+StringPlus.html_Encode(ex.getMessage())+"<br>");
            ...
            out.println("       <form name='error' method='post' action='" + this.getSubscriber_Organization_Portal().getWeb_Root()+
            "/Launcher_Servlet'>");
...
//            "\");");
            ...
            log("Error in "+ servlet_Path_Name, ex);
    ...
    public synchronized void end() {
        ...
        try {
            ...
            if(this.parent_Web_Process_Id !=0){
    ...
    public synchronized void end_And_Launch_Task(String task, String options) {
        ...
        try {
            ...
            //            if(this.parent_Web_Process_Id !=0){
            //                command= "/Launcher_Servlet?action=Start&command=/"+task+"&parent_Process_Id="+ this.parent_Web_Process_Id;
     ...
     * if no such ID#.
     */
    public synchronized static Web_Process  get_Instance_From_Table(HttpServlet servlet, HttpServletRequest request, HttpServletResponse response, long ps_Id)
    throws WPException {
        ...
        //            throw new WPException("This session has timed-out.");
        //        }
    ...
    public synchronized static Web_Process  get_Instance_From_Table(HttpServlet servlet, HttpServletRequest request, HttpServletResponse response, String ps_Id)
    throws WPException {
    ...
    public synchronized static Web_Process get_For_Servlet(HttpServlet servlet, HttpServletRequest request, HttpServletResponse response)
    throws WPException {
        String message;
        ...
        web_Process = Web_Process.get_Instance_From_Table(servlet, request, response, ps_Id);
    ...
    public void do_Display_HTML_Head_Begin_Std(PrintWriter out, String title){
        ...
        if(this.subscriber_Organization_Portal.getUse_Std_Css_Theme().getValue().booleanValue())
            ...
            out.println("   <link rel='stylesheet' type='text/css' href='" + web_Root + css_Root + "/Themes/"+ this.subscriber_Organization_Portal.getCustom_Css_Theme_Name().toString()+".css' >");
        ...
        out.println("<script language='JavaScript' type='text/JavaScript' src='" + web_Root + subscriber_Organization_Portal.getMenu_Js_Path() +"'></script>");
        
        out.println("<script type='text/javascript' src='" + web_Root + "/include/AutoComplete.js' ></script>");
        out.println("<script language='JavaScript' src='" + web_Root + "/scripts/date_selector/date_selector.js'></script>");
        out.println("<script language='JavaScript' type='text/JavaScript' src='" + web_Root + "/scripts/MM_findObj.js'></script>");
        out.println("<script language='JavaScript' type='text/JavaScript' src='" + web_Root + "/scripts/MM_showHideLayers.js'></script>");
        out.println("<script language='JavaScript' type='text/JavaScript' src='" + web_Root + "/scripts/My_Escape.js'></script>");
    ...
    public void do_Display_HTML_Form_Begin_Std(PrintWriter out, String form_Name) throws WPException {
        ...
        this.html_Form_Tag=new HTML_Form_Tag(form_Name, this.servlet_Path_Name.substring(1), out);
    ...
    public void do_Display_HTML_Form_Begin_Href_Blank(PrintWriter out, String form_Name, String href) throws WPException {
        if(this.html_Form_Tag != null)
            throw new WPException("Error! Trying to begin form_Name:" + form_Name + ":  While still in form_Name:" + this.html_Form_Tag.getForm_Name()+":  Please correct program.");
        this.html_Form_Tag=new HTML_Form_Tag(form_Name, href, out);
    ...
    public String get_HTML_Of_Heading_Sort_Href(Display_List_Sort_Manager display_List_Sort_Manager, DFBase dfBase){
        ...
        if(display_List_Sort_Manager != null)
            href.append("   <img src='" + web_Root + "/images" +display_List_Sort_Manager.getField_Direction_Image(dfBase.getField_Name()) + "' alt='Srt' border='0' align='right'>\n");
    ...
    throws WPException {
        ...
        result.append(this.servlet_Path_Name + this.get_HTML_Of_Href_Call_Parameters() + "&action=Reload&page="+prefix+"first'> <img src='" + web_Root + "/images/buttons/page_first_pointer.png' border='0' alt='first page'><a/></td>\n");
        
        
        
        result.append("<td nowrap ><a  href='" + web_Root);
        
        result.append(this.servlet_Path_Name + this.get_HTML_Of_Href_Call_Parameters() + "&action=Reload&page="+prefix+"prev'> <img src='" + web_Root + "/images/buttons/page_prev_pointer.png' border='0' alt='previous page'><a/></td>\n");
        ...
        result.append("<input type='hidden' name='action' value='Reload'>Page </input>\n");
        
        
        result.append("<input type='text' name='"+prefix+"page' size=2 maxlength=4 value='" + display_List_Pagination_Manager.getCurrent_Page() + "'>&nbsp; of " + display_List_Pagination_Manager.getLast_Page_Number() + "</input>\n");
        ...
        result.append(this.servlet_Path_Name + this.get_HTML_Of_Href_Call_Parameters() + "&action=Reload&page="+prefix+"next'> <img src='" + web_Root + "/images/buttons/page_next_pointer.png' border='0' alt='next page'><a/></td>\n");
        ...
        result.append(this.servlet_Path_Name + this.get_HTML_Of_Href_Call_Parameters() + "&action=Reload&page="+prefix+"last'> <img src='" + web_Root + "/images/buttons/page_last_pointer.png' border='0' alt='last page'><a/></td>\n");
