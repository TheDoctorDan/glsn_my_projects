 ...
 * @author  dgleeson
 */
public class DFString_Encrypted extends DFBase {
    ...
    /** Creates a new instance of DFString_Encrypted */
    
    
    public DFString_Encrypted(String field_Name, String field_Title, int max_Length) throws DFException {
    ...
    public DFString_Encrypted(String field_Name, String field_Title, int min_Length, int max_Length) throws DFException {
        super(field_Name, field_Title);
    ...
    public boolean same_Field_Layout(DFBase dFBase){
        if (dFBase instanceof DFString_Encrypted){
            
            DFString_Encrypted temp = (DFString_Encrypted) dFBase;
