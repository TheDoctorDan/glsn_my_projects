 ...
 * @author  dgleeson
 */
public class Connect_To_Data_Base  {
    ...
    public Connect_To_Data_Base(Site_Constants site_Constants) throws IOException {
        ...
        try {
            ...
            try{
                ...
                message ="Connect_To_Data_Base: Error getting Connection to database, SQLException: " + sqle.getMessage();
            ...
            message ="Connect_To_Data_Base: Error loading driver for database, ClassNotFoundException: " + cnfe.getMessage();
            throw new IOException(message);
        }
        
        catch (InstantiationException ie){
            message ="Connect_To_Data_Base: Error loading driver for database, InstantiationException: " + ie.getMessage();
            throw new IOException(message);
            
        }
        catch (IllegalAccessException iae){
            message ="Connect_To_Data_Base: Error loading driver for database, IllegalAccessException: " + iae.getMessage();
            throw new IOException(message);
    ...
    public /* static */ synchronized Connection getConnection(Site_Constants site_constants)  throws IOException {
      //  if(connect_To_Data_Base_Instance == null){
      //      connect_To_Data_Base_Instance = new Connect_To_Data_Base(site_constants);
      //  }
    ...
    public /* static */ synchronized Connection reValidate_Connection(Connection connection) throws IOException {
        ...
        if(need_to_reopen){
            try {
                ...
                message ="Connect_To_Data_Base.reValidate_Connection(): Error getting Connection to database, SQLException: " + sqle.getMessage();
                throw new IOException(message);
            }
        }
        ...
        try {
            System.out.println("Auto Commit=" + connection.getAutoCommit());
                ...
                message ="Connect_To_Data_Base.reValidate_Connection(): Error getting Connection getAutoCommit(), SQLException: " + sqle.getMessage();
                throw new IOException(message);
        }
         */
