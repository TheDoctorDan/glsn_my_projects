...
public class Bread_Crumb_List {
    ...
    public void dispatch(HttpServletResponse response) throws NoSuchElementException, java.io.IOException {
        Bread_Crumb_Node bread_Crumb_Node = (Bread_Crumb_Node) this.linkedList.getLast();
        bread_Crumb_Node.dispatch(response);
    }

    public void reload_Dispatch(HttpServletResponse response) throws NoSuchElementException, java.io.IOException {
        Bread_Crumb_Node bread_Crumb_Node = (Bread_Crumb_Node) this.linkedList.getLast();
        bread_Crumb_Node.reload_Dispatch(response);
    }
    ...
    public String to_Html(String my_Selected_Tbl_Text_Color, String my_Selected_Tbl_Bg_Color, HttpServletRequest request){
        ...
        for(int i = 0; i< this.linkedList.size() && !done; i++){
            ...
            if(my_Page.endsWith(bread_Crumb_Node.getDestination_URL())){
                ...
                if(bread_Crumb_Node.getReload_URL()==null || bread_Crumb_Node.getReload_URL().equals("")){
                    result.append("<a href=" + Nav_Base.getBase_URL() + bread_Crumb_Node.getDestination_URL() + ">");
                }else{
                    result.append("<a href=" + Nav_Base.getBase_URL() + bread_Crumb_Node.getReload_URL() + ">");
                }
                result.append(bread_Crumb_Node.getLabel());
                result.append("</a>\n");
                result.append("</th>\n");
