...
public class Display_List_Sort_Manager {
    ArrayList   display_List_Sort_Nodes;
    
    /** Creates a new instance of Display_List_Sort_Manager */
    public Display_List_Sort_Manager() {
        display_List_Sort_Nodes = new ArrayList();
    }
    
    /* CUD change, update, delete */
    public void sort_Field_CUD(String field_Name){
    ...
    public int getSort_Field_Direction(String field_Name){
        Display_List_Sort_Node display_List_Sort_Node=null;
    ...
    public String getField_Direction_Image(String field_Name){
        Display_List_Sort_Node display_List_Sort_Node= null;
