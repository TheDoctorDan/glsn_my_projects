...
public class LaDate {
	...
	**/
	public static LaDate from_Gregorian_10mdcy(String date_str) throws Bad_Date_Exception
	{
		...
		if(date_str.length()!=10){
			...
			year=new Integer(date_str.substring(8,10)).intValue();
	...
	**/
	public String	to_Gregorian_8mdy()
	{
		...
		return(StringPlus.left_Fill(ladate_record.month_of_year+1, 2, '0') +"/"
		     + StringPlus.left_Fill(ladate_record.day_of_month+1, 2, '0') +"/"
		     + StringPlus.left_Fill(ladate_record.year, 2, '0'));
	}
	...
	**/
	...
	public String to_Gregorian_10mdcy()
	{
		...
		return(StringPlus.left_Fill(ladate_record.month_of_year+1, 2, '0') +"/"
		     + StringPlus.left_Fill(ladate_record.day_of_month+1, 2, '0') +"/"
		     + StringPlus.left_Fill(ladate_record.century, 2, '0')
		     + StringPlus.left_Fill(ladate_record.year, 2, '0'));
	}
