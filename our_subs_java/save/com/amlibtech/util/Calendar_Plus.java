...
public class Calendar_Plus {
    ...
    public static String[] month_Names = { "January", "February", "March", "April", "May", "June", "July", "August", "Septmber", "October", "November", "December" };
	...
	return StringPlus.left_Fill((calendar.get(Calendar.MONTH) + 1), 2, '0') + "/" + StringPlus.left_Fill(calendar.get(Calendar.DAY_OF_MONTH), 2, '0') + "/" + calendar.get(Calendar.YEAR);
    }
	...
	return StringPlus.left_Fill(calendar.get(Calendar.YEAR), 4, '0') + "-" + StringPlus.left_Fill((calendar.get(Calendar.MONTH) + 1), 2, '0') + "-" + StringPlus.left_Fill(calendar.get(Calendar.DAY_OF_MONTH), 2, '0');
    }
	...
	return month_Names[calendar.get(Calendar.MONTH)] + " " + calendar.get(Calendar.DAY_OF_MONTH) + ", " + calendar.get(Calendar.YEAR) + " " + (calendar.get(Calendar.HOUR)) + ":" + StringPlus.left_Fill(calendar.get(Calendar.MINUTE), 2, '0') + ":" + StringPlus.left_Fill(calendar.get(Calendar.SECOND), 2, '0') + " " + meridian_Abbr[(calendar.get(Calendar.AM_PM) == Calendar.AM ? 0 : 1)] + " " + calendar.getTimeZone().getDisplayName(calendar.getTimeZone().inDaylightTime(calendar.getTime()), TimeZone.SHORT, Locale.US);
	...
	return StringPlus.left_Fill(hour, 2, '0') + ":" + StringPlus.left_Fill(calendar.get(Calendar.MINUTE), 2, '0') + ":" + StringPlus.left_Fill(calendar.get(Calendar.SECOND), 2, '0') + " " + meridian_Abbr[(calendar.get(Calendar.AM_PM) == Calendar.AM ? 0 : 1)];
    }
	...
	return StringPlus.left_Fill(calendar.get(Calendar.HOUR_OF_DAY), 2, '0') + ":" + StringPlus.left_Fill(calendar.get(Calendar.MINUTE), 2, '0') + ":" + StringPlus.left_Fill(calendar.get(Calendar.SECOND), 2, '0');
    }
