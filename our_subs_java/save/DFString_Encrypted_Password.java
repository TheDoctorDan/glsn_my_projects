/*
 * DFString_Encrypted_Password.java
 *
 ...
 * @author  dgleeson
 */
public class DFString_Encrypted_Password extends DFString_Encrypted {
    ...
    /** Creates a new instance of DFString_Encrypted_Password */
    
    public DFString_Encrypted_Password(String field_Name, String field_Title, int max_Length) throws DFException {
        super(field_Name, field_Title, max_Length);
    }
    
    public DFString_Encrypted_Password(String field_Name, String field_Title, int min_Length, int max_Length) throws DFException {
