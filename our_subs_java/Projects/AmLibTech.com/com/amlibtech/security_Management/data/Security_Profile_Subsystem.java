/*
 * Security_Profile_Subsystem.java
 *
 * Created on November 14, 2006, 9:23 AM
 */
 ...
 * @author  dgleeson
 */
public class Security_Profile_Subsystem extends Database_Record_Base {
    ...
    // Empty Constructor
    /** Creates a new instance of Security_Profile_Subsystem
     * @throws Database_Record_Constructor_Exception
     */
    public Security_Profile_Subsystem() throws Database_Record_Constructor_Exception {
        super("Security Profile Subsystem", "Security Profile Subsystems");
        try {
            ...
            DFBase[] index =   { this.security_Profile_Id, this.subsystem_Id };
    ...
    /** Creates a new instance of Security_Profile_Subsystem with key fields set to passed values.
     * @throws Database_Record_Constructor_Exception
     */
    public Security_Profile_Subsystem(String security_Profile_Id, String subsystem_Id) throws Database_Record_Constructor_Exception {
        this();
        try {
    ...
    public String get_Table_Name() {
        return "security_profile_subsystem";
    }
     ...
     * @return Security_Profile_Subsystem[] the size of array_Size as an Database_Record_Base[].
     */
    public Database_Record_Base[] get_Array_of_Records(int array_Size) {
        Security_Profile_Subsystem[] security_Profile_Subsystem_Records;
        security_Profile_Subsystem_Records = new Security_Profile_Subsystem[array_Size];
        return security_Profile_Subsystem_Records;
    }
    ...
    public String getSQL_Create_Table() {
        ...
        out.append("        PRIMARY KEY  (`" + security_Profile_Id.getField_Name() + "`, `" + subsystem_Id.getField_Name() + "`)\n");
    ...
    public String getNext_Sort_Clause(int which_Index) throws Database_Front_Exception {
        switch(which_Index){
            case PRIMARY_INDEX:
                return "ORDER BY security_Profile_Id ASC, subsystem_Id ASC";
            default:
     ...
     * @return Security_Profile_Subsystem record.
    ...
    public synchronized Database_Record_Base resultSet_Row_Decode(java.sql.ResultSet resultSet) throws Database_Record_Constructor_Exception {
        Security_Profile_Subsystem result;
        try {
            result = new Security_Profile_Subsystem();
     ...
     */
    public synchronized Security_Profile_Subsystem copy_Of() throws Database_Record_Constructor_Exception {
        Security_Profile_Subsystem result;
        try {
            result = new Security_Profile_Subsystem();

            result.security_Profile_Id.setValue(this.security_Profile_Id.getValue());
            result.subsystem_Id.setValue(this.subsystem_Id.getValue());
    ...
    throws Database_Record_Constructor_Exception {
        ...
        this.subsystem_Id.setRequest_Error("");

        try {
            Subsystem subsystem = Subsystem.get_Subsystem(this.subsystem_Id.getValue());
        }catch(Database_Front_Exception dbfe){
            this.subsystem_Id.setRequest_Error("Database Error. " + dbfe.getMessage());
            error_Count++;
        }catch(Database_Front_No_Results_Exception dbfe){
            this.subsystem_Id.setRequest_Error("No Such Subsystem.");
            error_Count++;
        }
