/*
 * DFString_Encrypted_OBSOLETE.java
 *
 ...
 * @author  dgleeson
 */
public class DFString_Encrypted_OBSOLETE extends DFBase {
    ...
    /** Creates a new instance of DFString_Encrypted_OBSOLETE */
    
    
    public DFString_Encrypted_OBSOLETE(String field_Name, String field_Title, int max_Length) throws DFException {
    ...
    public DFString_Encrypted_OBSOLETE(String field_Name, String field_Title, int min_Length, int max_Length) throws DFException {
        super(field_Name, field_Title);
    ...
    public String getSQL_Declaration(){
        return ("`" + this.field_Name + "` " + sql_Type + "(" + this.byte_Array_Length + ") NOT NULL default '',\n");
    }
    
    public String getSQL_Declaration(String default_Value){
        return ("`" + this.field_Name + "` " + sql_Type + "(" + this.byte_Array_Length + ") NOT NULL default '" + default_Value + "',\n");
    }
    ...
    public boolean same_Field_Layout(DFBase dFBase){
        if (dFBase instanceof DFString_Encrypted_OBSOLETE){
            
            DFString_Encrypted_OBSOLETE temp = (DFString_Encrypted_OBSOLETE) dFBase;
            ...
            if(this.byte_Array_Length != temp.max_Length)
                return false;
            return true;
