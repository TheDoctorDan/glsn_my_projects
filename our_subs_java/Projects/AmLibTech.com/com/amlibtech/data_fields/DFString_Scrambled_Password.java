/*
 * DFString_Scrambled_Password.java
 *
 ...
 * @author  dgleeson
 */
public class DFString_Scrambled_Password extends DFString_Scrambled {
    ...
    /** Creates a new instance of DFString_Scrambled_Password */
    
    public DFString_Scrambled_Password(String field_Name, String field_Title, int max_Length) throws DFException {
        super(field_Name, field_Title, max_Length);
    }
    
    public DFString_Scrambled_Password(String field_Name, String field_Title, int min_Length, int max_Length) throws DFException {
