 ...
 * @author  dgleeson
 */
public class DFString extends DFBase {
    ...
    /** Creates a new instance of DFString */
    
    
    public DFString(String field_Name, String field_Title, int max_Length) throws DFException {
    ...
    public DFString(String field_Name, String field_Title, int min_Length, int max_Length) throws DFException {
        super(field_Name, field_Title);
