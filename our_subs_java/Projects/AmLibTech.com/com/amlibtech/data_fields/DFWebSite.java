 ...
 * @author  dgleeson
 */
public class DFWebSite extends DFString {
    
    
    /**
     * Creates a new instance of DFWebSite
     * @param field_Name
     * @param field_Title
     * @throws DFException
     */
    public DFWebSite(String field_Name, String field_Title) throws DFException {
     ...
     * @throws DFException
     */
    public DFWebSite(String field_Name, String field_Title, int min_Length) throws DFException {
    ...
    public void setValue(String passed_Value) throws DFException {
        ...
        if(!passed_Value.equals("")){
            if(!passed_Value.toLowerCase().startsWith("http://") && !passed_Value.toLowerCase().startsWith("https://")){
                throw new DFException(this.field_Title + " must begin with http:// or https://.");
            }
        }
    ...
    public String toHTML() {
        if(!this.toString().toLowerCase().startsWith("http://") && !this.toString().toLowerCase().startsWith("https://")){
            // no : so add one
