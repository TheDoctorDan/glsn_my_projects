/*
 * Organization_School_AutoCompletion.java
 *
...
public class Organization_School_AutoCompletion extends HttpServlet {

    /** Returns a short description of the servlet.
     */
    public String getServletInfo() {
        return "Organization School AutoCompletion Servlet";
    }
    ...
    throws ServletException, IOException {
        ...
        if(action.equals("nameLookup")){
            ...
            try {
                ...
                temp_Organization.setOrganization_Type_Id(Organization_Type.TYPE_SCHOOL);
                ...
                web_Process.log("Organization_School_AutoCompletion  : " + dfe.getMessage());
                do_Respond_Invalid(response);
                return;
            }
            ...
            " AND " + temp_Organization.getOrganization_Type_Id().toWhere_Clause();
		...
		sort_Clause, 0, 10);
            ...
            if(!organization.getOrganization_Type_Id().getValue().equals(Organization_Type.TYPE_SCHOOL)){
                do_Respond_Invalid(response);
                return;
            }
    ...
    String form_Field_Id_Of_Id, String form_Field_Id_Of_Name, String form_Field_Id_Of_Comp_Id){
        ...
        out.println("        " + form_Field_Id_Of_Id + "_ClearTable();");
        out.println("    } else {");
        out.println("        var url = \"Organization_School_AutoCompletion"+web_Process.get_HTML_Of_Href_Call_Parameters()+
        "&action=nameLookup"+
