 ...
 * Entity_Control.java
 *
 * Created on August 10, 2006, 3:49 PM
 */
 ...
 * @author  dgleeson
 */
public class Entity_Control extends Database_Record_Base {

    private DFString_Filled comp_Id;

    private DFInteger last_Used_Person_Number;
    private DFInteger last_Used_Organization_Number;
    private DFInteger   last_Used_Family_Number;
    ...
    // Empty Constructor
    /** Creates a new instance of Entity_Control
     * @throws Database_Record_Constructor_Exception
     */
    public Entity_Control() throws Database_Record_Constructor_Exception {
        super("Entity_Control", "Entity_Controls");
        try {
            this.comp_Id =  Comp.DFInit_Comp_Id();
            this.last_Used_Person_Number =  new DFInteger("last_Used_Person_Number", "Last Used Person Number", Person.PERSON_NUMBER_LEN);
            this.last_Used_Organization_Number =  new DFInteger("last_Used_Organization_Number", "Last Used Organization Number", Organization.ORGANIZATION_NUMBER_LEN);
            this.last_Used_Family_Number =  new DFInteger("last_Used_Family_Number", "Last Used Family Number", Family.FAMILY_NUMBER_LEN);
    ...
    /** Creates a new instance of Entity_Control with key fields set to passed values.
     * @throws Database_Record_Constructor_Exception
     */
    public Entity_Control(String comp_Id) throws Database_Record_Constructor_Exception {
        this();
        try {
     ...
     * @return Entity_Control[] the size of array_Size as an Database_Record_Base[].
     */
    public Database_Record_Base[] get_Array_of_Records(int array_Size) {
        Entity_Control[] entity_Control_Records;
        entity_Control_Records = new Entity_Control[array_Size];
        return entity_Control_Records;
    }
    ...
    public String getSQL_Create_Table() {
        ...
        out.append("\t" + last_Used_Person_Number.getSQL_Declaration());
        out.append("\t" + last_Used_Organization_Number.getSQL_Declaration());
        out.append("\t" + last_Used_Family_Number.getSQL_Declaration());
        ...
        try {
            for(int pass=1;pass<=2;pass++){
                ...
                (pass == 1 && order == ORDER_KEYS_NEVER)
                    ...
                    preparedStatement = this.last_Used_Person_Number.get_PreparedStatement_Value(preparedStatement, count++);
                    preparedStatement = this.last_Used_Organization_Number.get_PreparedStatement_Value(preparedStatement, count++);
                    preparedStatement = this.last_Used_Family_Number.get_PreparedStatement_Value(preparedStatement, count++);
                }
            }
        }
        catch(DFException dfe){
    ...
    public synchronized Database_Record_Base resultSet_Row_Decode(java.sql.ResultSet resultSet) throws Database_Record_Constructor_Exception {
        Entity_Control result;
        try {
            result = new Entity_Control();

            result.comp_Id.setValue_ResultSet(resultSet);
            result.last_Used_Person_Number.setValue_ResultSet(resultSet);
            result.last_Used_Organization_Number.setValue_ResultSet(resultSet);
            result.last_Used_Family_Number.setValue_ResultSet(resultSet);
    ...
    public synchronized void validate_Fields_Of_Request(String prefix, HttpServletRequest httpServletRequest, Database_Front database_Front, String suffix) throws Database_Record_Exception {
        ...
        error_Count += this.last_Used_Person_Number.validate_Request(prefix, httpServletRequest, suffix);
        error_Count += this.last_Used_Organization_Number.validate_Request(prefix, httpServletRequest, suffix);
        error_Count += this.last_Used_Family_Number.validate_Request(prefix, httpServletRequest, suffix);
    ...
    public DFBase[] get_Field_List() {
        ...
        programmers_Field_List.add( last_Used_Person_Number );
        programmers_Field_List.add( last_Used_Organization_Number );
        programmers_Field_List.add( last_Used_Family_Number );
    ...
    /**
     * Getter for property last_Used_Person_Number.
     * @return Value of property last_Used_Person_Number.
     */
    public DFInteger getLast_Used_Person_Number() {
        return last_Used_Person_Number;
    }


    /**
     * Setter for property last_Used_Person_Number.
     * @param last_Used_Person_Number New value of property last_Used_Person_Number.
     */
    public void setLast_Used_Person_Number(Integer last_Used_Person_Number) throws DFException {
        this.last_Used_Person_Number.setValue(last_Used_Person_Number);
    }


    /**
     * Getter for property last_Used_Organization_Number.
     * @return Value of property last_Used_Organization_Number.
     */
    public DFInteger getLast_Used_Organization_Number() {
        return last_Used_Organization_Number;
    }


    /**
     * Setter for property last_Used_Organization_Number.
     * @param last_Used_Organization_Number New value of property last_Used_Organization_Number.
     */
    public void setLast_Used_Organization_Number(Integer last_Used_Organization_Number) throws DFException {
        this.last_Used_Organization_Number.setValue(last_Used_Organization_Number);
    }


    /**
     * Getter for property last_Used_Family_Number.
     * @return Value of property last_Used_Family_Number.
     */
    public DFInteger getLast_Used_Family_Number() {
        return last_Used_Family_Number;
    }


    /**
     * Setter for property last_Used_Family_Number.
     * @param last_Used_Family_Number New value of property last_Used_Family_Number.
     */
    public void setLast_Used_Family_Number(Integer last_Used_Family_Number) throws DFException {
        this.last_Used_Family_Number.setValue(last_Used_Family_Number);
    }
    ...
    public static Integer get_Next_Person_Number(Database_Front database_Front, DFString comp_Id)
    throws Database_Front_Exception, Database_Front_No_Results_Exception, Database_Front_Deadlock_Exception, Database_Record_Exception, Database_Record_Constructor_Exception {
        ...
        entity_Control = (Entity_Control)database_Front.getLocked_Record(new Entity_Control(comp_Id.getValue()));
        entity_Control.last_Used_Person_Number.addEqual(1);
        while(database_Front.isMatch(new Person(entity_Control.getComp_Id().getValue(), entity_Control.last_Used_Person_Number.getValue()))){
            entity_Control.last_Used_Person_Number.addEqual(1);
        }
        database_Front.updateRecord_Dont_Unlock(entity_Control);
        return entity_Control.last_Used_Person_Number.getValue();
    }


    public static Integer get_Next_Organization_Number(Database_Front database_Front, DFString comp_Id)
    throws Database_Front_Exception, Database_Front_No_Results_Exception, Database_Front_Deadlock_Exception, Database_Record_Exception, Database_Record_Constructor_Exception {
        Entity_Control entity_Control;
        entity_Control = (Entity_Control)database_Front.getLocked_Record(new Entity_Control(comp_Id.getValue()));
        entity_Control.last_Used_Organization_Number.addEqual(1);
        while(database_Front.isMatch(new Organization(entity_Control.getComp_Id().getValue(), entity_Control.last_Used_Organization_Number.getValue()))){
            entity_Control.last_Used_Organization_Number.addEqual(1);
        }
        database_Front.updateRecord(entity_Control);
        return entity_Control.last_Used_Organization_Number.getValue();
    }


    public static Integer get_Next_Family_Number(Database_Front database_Front, DFString comp_Id)
    throws Database_Front_Exception, Database_Front_No_Results_Exception, Database_Front_Deadlock_Exception, Database_Record_Exception, Database_Record_Constructor_Exception {
        Entity_Control entity_Control;
        entity_Control = (Entity_Control)database_Front.getLocked_Record(new Entity_Control(comp_Id.getValue()));
        entity_Control.last_Used_Family_Number.addEqual(1);
        while(database_Front.isMatch(new Family(entity_Control.getComp_Id().getValue(), entity_Control.last_Used_Family_Number.getValue()))){
            entity_Control.last_Used_Family_Number.addEqual(1);
        }
        database_Front.updateRecord(entity_Control);
        return entity_Control.last_Used_Family_Number.getValue();
    }
