/*
 * Organization_Contact_Type.java
 *
 * Created on August 17, 2006, 8:30 PM
 *
 * Enty011 maint
 */
 ...
 * @author  dgleeson
 */
public class Organization_Contact_Type extends Database_Record_Base {
    
    private DFString_Filled	comp_Id;
    private DFString organization_Type_Id;
    private DFString organization_Contact_Type_Id;
    
    public static final int ORGANIZATION_CONTACT_TYPE_ID_LEN = 20;

    public static DFString DFInit_Organization_Contact_Type_Id() 
    throws DFException {
        return new DFString("organization_Contact_Type_Id", "Organization Contact Type", 1, ORGANIZATION_CONTACT_TYPE_ID_LEN);
    }
    
    public static DFString DFInit_Organization_Contact_Type_Id(String field_Name, String field_Title) 
    throws DFException {
        return new DFString(field_Name, field_Title, 1, ORGANIZATION_CONTACT_TYPE_ID_LEN);
    }
    ...
    // Empty Constructor
    /** Creates a new instance of Organization_Contact_Type
     * @throws Database_Record_Constructor_Exception
     */
    public Organization_Contact_Type() throws Database_Record_Constructor_Exception {
        super("Organization Contact Type", "Organization Contact Types");
        try {
            this.comp_Id =  Comp.DFInit_Comp_Id();
            this.organization_Type_Id =  Organization_Type.DFInit_Organization_Type_Id();
            this.organization_Contact_Type_Id =  DFInit_Organization_Contact_Type_Id();

            DFBase[] index =   { this.comp_Id, this.organization_Type_Id, this.organization_Contact_Type_Id };
    ...
    /** Creates a new instance of Organization_Contact_Type with key fields set to passed values.
     * @throws Database_Record_Constructor_Exception
     */
    public Organization_Contact_Type(String comp_Id, String organization_Type_Id, String organization_Contact_Type_Id) throws Database_Record_Constructor_Exception {
        this();
        try {
            this.comp_Id.setValue(comp_Id);
            this.organization_Type_Id.setValue(organization_Type_Id);
            this.organization_Contact_Type_Id.setValue(organization_Contact_Type_Id);
    ...
    public String get_Table_Name() {
        return "organization_contact_type";
    }
    ...
    public synchronized void is_Delete_Allowed(Database_Front database_Front, HttpSession httpSession) throws Database_Record_Exception, Database_Record_Constructor_Exception {
        ...
        
        {
            ...
            try {
                ...
                organization.setPhone_Contact_Type(this.organization_Contact_Type_Id.getValue());
                organization.setE_Mail_Contact_Type(this.organization_Contact_Type_Id.getValue());
                organization.setFax_Contact_Type(this.organization_Contact_Type_Id.getValue());
            }catch(DFException dfe){
            ...
            try{
                ...
                organization.getComp_Id().toWhere_Clause() +
                 " AND " + organization.getOrganization_Type_Id().toWhere_Clause() +
                 " AND ( " + organization.getPhone_Contact_Type().toWhere_Clause() +
                 "        OR " + organization.getE_Mail_Contact_Type().toWhere_Clause() +
                 "        OR " + organization.getFax_Contact_Type().toWhere_Clause() +
                 "      ) "
                 );
     ...
     * @return Organization_Contact_Type[] the size of array_Size as an Database_Record_Base[].
     */
    public Database_Record_Base[] get_Array_of_Records(int array_Size) {
        Organization_Contact_Type[] organization_Contact_Type_Records;
        organization_Contact_Type_Records = new Organization_Contact_Type[array_Size];
        return organization_Contact_Type_Records;
    }
    ...
    public String getSQL_Create_Table() {
        ...
        out.append("\t" + organization_Contact_Type_Id.getSQL_Declaration());


        out.append("        PRIMARY KEY  (`" + comp_Id.getField_Name() + "`, `" + organization_Type_Id.getField_Name() + "`, `" + organization_Contact_Type_Id.getField_Name() + "`)\n");
    ...
    public String getNext_Sort_Clause(int which_Index) throws Database_Front_Exception {
        switch(which_Index){
            case PRIMARY_INDEX:
                return "ORDER BY comp_Id ASC, organization_Type_Id ASC, organization_Contact_Type_Id ASC";
            default:
        ...
        case PRIMARY_INDEX:
            ...
            case 0:
                return "WHERE comp_Id = '" + SQLUtil.encode(this.comp_Id.toString()) + "' "
                    ...
                    + " AND organization_Contact_Type_Id > '" + SQLUtil.encode(this.organization_Contact_Type_Id.toString()) + "' ";
            case 1:
                return "WHERE comp_Id = '" + SQLUtil.encode(this.comp_Id.toString()) + "' "
                    + " AND organization_Type_Id > '" + SQLUtil.encode(this.organization_Type_Id.toString()) + "' ";
            case 2:
        ...
        try {
            for(int pass=1;pass<=2;pass++){
                ...
                (pass == 2 && order == ORDER_KEYS_LAST)
                    ...
                    preparedStatement = this.organization_Contact_Type_Id.get_PreparedStatement_Value(preparedStatement, count++);
                }
                if((pass == 1 && order == ORDER_KEYS_FIRST) ||
     ...
     * @return Organization_Contact_Type record.
    ...
    public synchronized Database_Record_Base resultSet_Row_Decode(java.sql.ResultSet resultSet) throws Database_Record_Constructor_Exception {
        Organization_Contact_Type result;
        try {
            result = new Organization_Contact_Type();

            result.comp_Id.setValue_ResultSet(resultSet);
            result.organization_Type_Id.setValue_ResultSet(resultSet);
            result.organization_Contact_Type_Id.setValue_ResultSet(resultSet);
    ...
    public synchronized void validate_Key_Fields_Of_Request(String prefix, HttpServletRequest httpServletRequest, Database_Front database_Front, String suffix) throws Database_Record_Exception {
        ...
        error_Count += this.organization_Contact_Type_Id.validate_Request(prefix, httpServletRequest, suffix);
    ...
    public DFBase[] get_Field_List() {
        ...
        programmers_Field_List.add( organization_Contact_Type_Id );
     ...
     */
    public synchronized Organization_Contact_Type copy_Of() throws Database_Record_Constructor_Exception {
        Organization_Contact_Type result;
        try {
            result = new Organization_Contact_Type();
            ...
            result.setOrganization_Contact_Type_Id(this.organization_Contact_Type_Id.getValue());
    ...
    /**
     * Getter for property organization_Contact_Type_Id.
     * @return Value of property organization_Contact_Type_Id.
     */
    public DFString getOrganization_Contact_Type_Id() {
        return organization_Contact_Type_Id;
    }


    /**
     * Setter for property organization_Contact_Type_Id.
     * @param organization_Contact_Type_Id New value of property organization_Contact_Type_Id.
     */
    public void setOrganization_Contact_Type_Id(String organization_Contact_Type_Id) throws DFException {
        this.organization_Contact_Type_Id.setValue(organization_Contact_Type_Id);
    }
