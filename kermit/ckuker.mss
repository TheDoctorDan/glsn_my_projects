...
creates a file in its directory (usually @q(/var/spool/uucp), on some systems
...
@example(/var/spool/uucp/LCK..ttyi6)
...
@begin(example)
-r--r--r--  1 fdc        4 May  7 13:02 /var/spool/uucp/LCK..ttyi6
@end(example)
