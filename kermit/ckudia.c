...
static
MDMINF MULTITECH = 		/* information for "Multitech" modem */
{
	35, 			/* dial_time */
	",", 		/* pause_chars */
	2, 			/* pause_time */
...
static t_signal	(*savAlrm)();	/* for saving alarm handler */
static t_signal	(*savInt)();		/* for saving interrupt handler */
