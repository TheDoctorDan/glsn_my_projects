/* RE_SID: @(%)/net/shipyard/files2/builds/capybara/unix/pcnfsvr/pcnfsd/SCCS/s.pcnfsd_svc.c 1.1 94/05/15 20:01:31 SMI */
...
#else RLIMIT_NOFILE
/*  could use getdtablesize() here, but I don't know who uses it */
		size = 20;
#endif RLIMIT_NOFILE
