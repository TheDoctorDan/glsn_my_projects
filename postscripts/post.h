...
extern void	copypage(int num);
extern void *memalloc(int length);
extern void memfree(void *beg, int length);
#else
extern int	flushlevel();
extern void flushlpage();
extern void	copypage();
...
#define arraycopy(aptr1, aptr2, length) \
    memcpy((char *) (aptr1), (char *) (aptr2), (int)((length) * sizeof (struct object)))
...
extern void initint();
extern void tidyint();
extern void systemname();
extern void systemop();
...
extern void putstr();
extern void putmem();
extern void putcheck();
extern void fileopen();
extern void fileclose();
extern struct file *filecheck();
extern int	getfseg();
extern void fileeinit();
extern int	readch();
extern void unreadch();
#endif
...
extern void nametoken(struct object *token, char *string, int length, int flags);
extern void dicttoken(struct object *token, int size);
extern void dictput(vmref dref, struct object *key, struct object *val);
extern int	dictget(vmref dref, struct object *key, struct object *val, int flags);
...
extern int	numtoken();
extern void nametoken();
extern void dicttoken();
extern void dictput();
extern int	dictget();
extern int	dictfind();
extern vmref arraypack();
extern void arrayunpk();
extern int	pack();
extern int	unpack();
#endif
...
extern void vmrestcheck(struct vmframe *vmframe, struct object *stackptr, int stackcnt);
...
extern void *vmallocv();
extern void *vmxptr();
extern char	*vmstring();
extern void vmallocseg();
extern void vmsavemem();
extern void vmsave();
extern void vmrest();
extern void vmrestcheck();
extern void vmrestfiles();
extern void vmrestnames();
extern void vmrestmem();
#endif

#ifdef __STDC__
extern int	cvstring(struct object *token, char *sptr, int length);
extern void printequals(FILE *fptr, struct object *token);
extern void printeqeq(FILE *fptr, struct object *token, int depth, int count);
...
extern void errorarray(struct object *token1, struct object *aptr, int length);
...
extern void stop();
extern void error();
extern void errorarray();
extern void errorexit();
extern void errormsg();
extern void errorjmp();
#endif
...
extern void show(struct object *string, int type, struct point *width, int wchar, struct object *proc);
...
extern void vmrestfont();
extern void definefont();
extern void findfont();
extern void makefont();
extern void setfont();
extern void checkfont();
extern void show();
extern void charpath();
extern void setcharwidth();
extern void setcachedevice();
extern void cachestatus();
extern void nulldevice();
extern void cacheimage();
#endif
...
extern void arc(int dir, float radaa[3], struct point *centre, struct point *beg, struct point *end);
extern void closepath(int type);
extern void flattenpath(void);
extern void strokepath(int fillflag);
extern void clip(int eoflag);
#else
extern void initgstate();
extern void initgraphics();
extern void initctm();
extern void setdevice();
extern void checkimagesize();
extern void checklinesize();
extern void checkpathsize();
extern void cliplength();
extern void clippath();
extern void gsave();
extern void grest();
extern void grestall();
extern void getmatrix();
extern void putmatrix();
extern void multiplymatrix();
extern void invertmatrix();
extern void transform();
extern void dtransform();
extern void itransform();
extern void idtransform();
extern void arc();
extern void closepath();
extern void flattenpath();
extern void strokepath();
extern void clip();
#endif
...
extern void image(int width, int height, int bps, float *matrix, int mode, int ncol, int multi, struct object *procs);
extern void erasepage(void);
#else
extern void setupfill();
extern void fill();
extern void filllines();
extern void setybucket();
extern void image();
extern void erasepage();
#endif
