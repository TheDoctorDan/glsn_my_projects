...
extern int	callextfunc(void (*func)(), int *argv, int argc);
...
#define POSTVERNO 17
char	version[] = "Post V1.7 Copyright Adrian Aylward 1989, 1992";
...
/* real Call external function */

int	callextfunc(void (*function)(), int *argv, int argc)
{
	switch(argc){
	case 0:
		function();
	...
	case 4:
		...
		break;
	case 5:
		function(argv[0] ,argv[1] ,argv[2] ,argv[3] ,argv[4] );
		break;
	case 6:
		function(argv[0] ,argv[1] ,argv[2] ,argv[3] ,argv[4] ,argv[5] );
		break;
	case 7:
		function(argv[0] ,argv[1] ,argv[2] ,argv[3] ,argv[4] ,argv[5] ,argv[6] );
		break;
	case 8:
		function(argv[0] ,argv[1] ,argv[2] ,argv[3] ,argv[4] ,argv[5] ,argv[6] ,argv[7] );
		break;
	case 9:
		function(argv[0] ,argv[1] ,argv[2] ,argv[3] ,argv[4] ,argv[5] ,argv[6] ,argv[7] ,argv[8] );
		break;
	case 10:
		function(argv[0] ,argv[1] ,argv[2] ,argv[3] ,argv[4] ,argv[5] ,argv[6] ,argv[7] ,argv[8] ,argv[9] );
		break;
	case 11:
		function(argv[0] ,argv[1] ,argv[2] ,argv[3] ,argv[4] ,argv[5] ,argv[6] ,argv[7] ,argv[8] ,argv[9] ,argv[10] );
		break;
	case 12:
		function(argv[0] ,argv[1] ,argv[2] ,argv[3] ,argv[4] ,argv[5] ,argv[6] ,argv[7] ,argv[8] ,argv[9] ,argv[10] ,argv[11] );
		break;
	case 13:
		function(argv[0] ,argv[1] ,argv[2] ,argv[3] ,argv[4] ,argv[5] ,argv[6] ,argv[7] ,argv[8] ,argv[9] ,argv[10] ,argv[11] ,argv[12] );
		break;
	case 14:
		function(argv[0] ,argv[1] ,argv[2] ,argv[3] ,argv[4] ,argv[5] ,argv[6] ,argv[7] ,argv[8] ,argv[9] ,argv[10] ,argv[11] ,argv[12] ,argv[13] );
		break;
	case 15:
		function(argv[0] ,argv[1] ,argv[2] ,argv[3] ,argv[4] ,argv[5] ,argv[6] ,argv[7] ,argv[8] ,argv[9] ,argv[10] ,argv[11] ,argv[12] ,argv[13] ,argv[14] );
		break;
	case 16:
		function(argv[0] ,argv[1] ,argv[2] ,argv[3] ,argv[4] ,argv[5] ,argv[6] ,argv[7] ,argv[8] ,argv[9] ,argv[10] ,argv[11] ,argv[12] ,argv[13] ,argv[14] ,argv[15] );
		break;
	case 17:
		function(argv[0] ,argv[1] ,argv[2] ,argv[3] ,argv[4] ,argv[5] ,argv[6] ,argv[7] ,argv[8] ,argv[9] ,argv[10] ,argv[11] ,argv[12] ,argv[13] ,argv[14] ,argv[15] ,argv[16] );
		break;
	case 18:
		function(argv[0] ,argv[1] ,argv[2] ,argv[3] ,argv[4] ,argv[5] ,argv[6] ,argv[7] ,argv[8] ,argv[9] ,argv[10] ,argv[11] ,argv[12] ,argv[13] ,argv[14] ,argv[15] ,argv[16] ,argv[17] );
		break;
	case 19:
		function(argv[0] ,argv[1] ,argv[2] ,argv[3] ,argv[4] ,argv[5] ,argv[6] ,argv[7] ,argv[8] ,argv[9] ,argv[10] ,argv[11] ,argv[12] ,argv[13] ,argv[14] ,argv[15] ,argv[16] ,argv[17] ,argv[18] );
		break;
	case 20:
	/* maxargs == 20 */
		function(argv[0] ,argv[1] ,argv[2] ,argv[3] ,argv[4] ,argv[5] ,argv[6] ,argv[7] ,argv[8] ,argv[9] ,argv[10] ,argv[11] ,argv[12] ,argv[13] ,argv[14] ,argv[15] ,argv[16] ,argv[17] ,argv[18] ,argv[19] );
		break;
	default:
		fprintf(stderr,"callextfunc: argc :%d: must be 0 - %d\n",maxargs);
		break;
	}
	return(0);
}
...
{
	return((errnum > 0 && errnum <= errmax) ? errortable[errnum] : NULL);
}
