#ifndef lint
static char rcsid[] = "$Header: /usr/people/sam/tiff/tools/RCS/tiffcmp.c,v 1.15 92/02/21 16:02:34 sam Exp $";
#endif
...
static	u_long imagewidth;
static	u_long imagelength;
